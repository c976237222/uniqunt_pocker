        ...
        match event:
            ...
            case SendEventEnum.UPDATE_TABLE_INFO:
                ...
                if type(data) == dict:
                    ...
                    # print(f'round: {num_round}, {last_action}')
                    # print('data: game status',  data['GameStatus']['Round'])
                    
                    if data['GameStatus']['Round'] == 4:
                        pass
                    elif data['GameStatus']['Round'] == 101: # 结算信息
            ...
            case SendEventEnum.UPDATE_ACTION:
                ...
                print(util.final_info_tostr(data))
